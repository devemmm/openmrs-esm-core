                    ...
                    <ItemSection>
                      ...
                      <Column>
                        <Row>
                          ...
                          <RowItem>
                            PRIMARY_CARE_ID : {selectedItem.UPI}
                          </RowItem>
                        </Row>
                      </Column>
                    </ItemSection>
                    ...
                    <ItemSection>
                      ...
                      <Column>
                        <Row>
                          <RowItem>
                            Country :{" "}
                            {e?.addressList[e.addressList.length - 1].country}
                          </RowItem>
                          <RowItem>
                            Province :{" "}
                            {e?.addressList[e.addressList.length - 1].state}
                          </RowItem>
                        </Row>
                        ...
                        <Row>
                          <RowItem>
                            District :{" "}
                            {e?.addressList[e.addressList.length - 1].district}
                          </RowItem>
                          <RowItem>
                            Sector :{" "}
                            {e?.addressList[e.addressList.length - 1].sector}
                          </RowItem>
                        </Row>
                        ...
                        <Row>
                          <RowItem>
                            Cell :{" "}
                            {e?.addressList[e.addressList.length - 1].cell}
                          </RowItem>
                          <RowItem>
                            Village :{" "}
                            {e?.addressList[e.addressList.length - 1].city}
                          </RowItem>
                        </Row>
                      </Column>
                    </ItemSection>
