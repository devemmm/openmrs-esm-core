...
function RegistrationForm() {
  ...
  const formSubmitHandler = (data) => {
    ...
    console.log(data);
    alert(
      "GENNEXT Team is still doing on this module... please contact system administrator."
    );
  };
  ...
  const selectHandler = (selectedData) => {
    ...
    const postalAddress = _.filter(
      selectedData?.addressList,
      (data) => data.type === "postal"
    );
    const residentialAddress = _.filter(
      selectedData?.addressList,
            ...
            <>
              <TextInputBox
                ...
                {...register("idsearchbox", {
                  required:
                    searchDropdown === "upid" || searchDropdown === "nid",
                })}
        ...
        <Section>
          ...
          <Card>
            <SelectBox
              ...
              {...register("rcountry")}
            >
              {JSONPath({ path: "value", json: mappedLocation }).map(
                (ele, index) => {
            ...
            >
              ...
              {JSONPath({ path: "children.*.value", json: mappedLocation }).map(
                (ele, index) => {
                  return <SelectItem value={ele} text={ele} key={index} />;
                }
              )}
        ...
        <Section>
          ...
          <Card>
            ...
            >
              <SelectItem disabled hidden value="" text="Select" />
              <SelectItem
                value="None/never attended"
                text="None/never attended"
              />
            ...
            >
              <SelectItem disabled hidden value="" text="Select" />
              <SelectItem
                value="Airline/Airport worker"
                text="Airline/Airport worker"
              />
